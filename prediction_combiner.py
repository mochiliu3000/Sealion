...
if __name__ == '__main__':
    ...
    result_df = pd.read_csv("./data/prediction/collected_prediction.csv")
    # result_df.to_csv("./data/prediction/collected_prediction")
    sum_all = sum_prediction(result_df)
    sum_all.to_csv("./data/prediction/sum_all.csv")
    print sum_all
    ...
    sum_all['pups'] = pred
    print(sum_all)
    sum_all.to_csv("./data/prediction/final_result.csv")
